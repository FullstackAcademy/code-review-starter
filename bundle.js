...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_reducers2.default, composeEnhancers((0, _redux.applyMiddleware)((0, _reduxLogger2.default)(), _reduxThunk2.default)));
	...
	store.dispatch((0, _category.getCategories)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootReducer = (0, _redux.combineReducers)({
	  auth: __webpack_require__(51).default, userProfile: _userProfile2.default,
	  categories: __webpack_require__(52).default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.postProduct = exports.getSingleProduct = exports.getProducts = exports.receiveProduct = exports.receiveProducts = undefined;
	...
	var getSingleProduct = exports.getSingleProduct = function getSingleProduct(productId) {
	  return function (dispatch) {
	...
	var postProduct = exports.postProduct = function postProduct(product) {
	  return function (dispatch) {
	    _axios2.default.post('/api/products', product).then(function (response) {
	      return response.data;
	    }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.postReview = exports.getAsSellerPendingReview = exports.getAsRenterPendingReview = exports.getAsSellerRatings = exports.getAsRenterRatings = exports.getSoldTransactions = exports.getRentedTransactions = exports.updateUserInfo = exports.getUserInfo = undefined;
	exports.default = setUserInfoReducer;
	...
	var SET_RENTED_TRANSACTIONS = 'SET_RENTED_TRANSACTIONS';
	var SET_SOLD_TRANSACTIONS = 'SET_SOLD_TRANSACTIONS';
	var SET_PENDING_RENT_TRANSACTIONS = 'SET_PENDING_RENT_TRANSACTIONS';
	var SET_PENDING_SELL_TRANSACTIONS = 'SET_PENDING_SELL_TRANSACTIONS';
	var SET_RENTING_RATINGS = 'SET_RENTING_RATINGS';
	var SET_SELLING_RATINGS = 'SET_SELLING_RATINGS';
	var SET_AS_RENTER_REVIEW = 'SET_AS_RENTER_REVIEW';
	var SET_AS_SELLER_REVIEW = 'SET_AS_SELLER_REVIEW';

	/* ------ action creators ------ */
	var setUserInfo = function setUserInfo(userInfo) {
	    return { type: SET_USER_INFO, userInfo: userInfo };
	};
	var setRentedTransactions = function setRentedTransactions(rentedTransactions) {
	    return { type: SET_RENTED_TRANSACTIONS, rentedTransactions: rentedTransactions };
	};
	var setSoldTransactions = function setSoldTransactions(soldTransactions) {
	    return { type: SET_SOLD_TRANSACTIONS, soldTransactions: soldTransactions };
	};
	var setPendingRentTransactions = function setPendingRentTransactions(pendingRentTransactions) {
	    return { type: SET_PENDING_RENT_TRANSACTIONS, pendingRentTransactions: pendingRentTransactions };
	};
	var setPendingSellTransactions = function setPendingSellTransactions(pendingSellTransactions) {
	    return { type: SET_PENDING_SELL_TRANSACTIONS, pendingSellTransactions: pendingSellTransactions };
	};
	var setSellingRatings = function setSellingRatings(sellingRatings) {
	    return { type: SET_SELLING_RATINGS, sellingRatings: sellingRatings };
	};
	var setRentingRatings = function setRentingRatings(rentingRatings) {
	    return { type: SET_RENTING_RATINGS, rentingRatings: rentingRatings };
	};
	var setAsRenterReview = function setAsRenterReview(reviews) {
	    return { type: SET_AS_RENTER_REVIEW, reviews: reviews };
	};
	var setAsSellerReview = function setAsSellerReview(reviews) {
	    return { type: SET_AS_SELLER_REVIEW, reviews: reviews };
	};

	/* ------  set user info reducer ------ */
	function setUserInfoReducer() {
	...
	var getUserInfo = exports.getUserInfo = function getUserInfo(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/userProfile/' + id).then(function (res) {
	            console.log('retrieving user info: ' + JSON.stringify(res));
	            dispatch(setUserInfo(res.data));
	        }).catch(function (err) {
	            return console.error('setting user info unsuccessful: ' + err);
	        });
	    };
	};

	/* update users info */
	var updateUserInfo = exports.updateUserInfo = function updateUserInfo(updateInfo) {
	    return function (dispatch) {
	        _axios2.default.put('/api/userProfile/', updateInfo).then(function (res) {
	...
	var getRentedTransactions = exports.getRentedTransactions = function getRentedTransactions(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/reservations/renter/' + id).then(function (res) {
	            var pendingReservations = res.data.filter(function (reservation) {
	                return reservation.pendingReservation;
	            });
	            dispatch(setPendingRentTransactions(pendingReservations));
	            var pastReservations = res.data.filter(function (reservation) {
	                return reservation.fulfilled;
	            });
	            dispatch(setRentedTransactions(pastReservations));
	        }).catch(function (err) {
	            return console.error('setting renter transactions unsuccessful: ' + err);
	        });
	    };
	};

	/* filter out pending and past transactions */
	var getSoldTransactions = exports.getSoldTransactions = function getSoldTransactions(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/reservations/seller/' + id).then(function (res) {
	            var pendingSellingTransactions = res.data.filter(function (transaction) {
	                return transaction.pendingReservation;
	            });
	            dispatch(setPendingSellTransactions(pendingSellingTransactions));
	            var soldTransactions = res.data.filter(function (transaction) {
	                return transaction.fulfilled;
	            });
	            dispatch(setSoldTransactions(soldTransactions));
	        }).catch(function (err) {
	            return console.error('setting sold transactions unsuccessful: ' + err);
	        });
	    };
	};
	...
	var getAsRenterRatings = exports.getAsRenterRatings = function getAsRenterRatings(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/ratings/renter/' + id).then(function (res) {
	            var rentingRatings = res.data.filter(function (reservation) {
	                return reservation.renterReview;
	            });
	...
	var getAsSellerRatings = exports.getAsSellerRatings = function getAsSellerRatings(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/ratings/seller/' + id).then(function (res) {
	            var sellingRatings = res.data.filter(function (reservation) {
	                return reservation.sellerReview;
	            });
	...
	var getAsRenterPendingReview = exports.getAsRenterPendingReview = function getAsRenterPendingReview(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/ratings/renter/' + id + '/pending').then(function (res) {
	            var asRenterPendingReview = res.data.filter(function (reservation) {
	...
	var getAsSellerPendingReview = exports.getAsSellerPendingReview = function getAsSellerPendingReview(id) {
	    return function (dispatch) {
	        _axios2.default.get('/api/ratings/seller/' + id + '/pending').then(function (res) {
	            var asSellerPendingReview = res.data.filter(function (reservation) {
	...
	/* post review */
	var postReview = exports.postReview = function postReview(review, userId) {
	    return function (dispatch) {
	        _axios2.default.post('/api/ratings', review).then(function (res) {
	            window.location.href = '/userProfile/' + userId + '/pendingReviews';
	        }).catch(function (err) {
	            return console.error('post review unsuccessful: ' + err);
	        });
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getUniqueAndSort = exports.getCategories = exports.receiveCategories = undefined;
	...
	var getUniqueAndSort = exports.getUniqueAndSort = function getUniqueAndSort(arr) {
	  var seen = {};
